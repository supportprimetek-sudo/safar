    ...
    >
      ...
      <div className="pt-12 text-center relative z-10">
        <div className="inline-flex items-center space-x-2 bg-[#202631]/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 text-xs font-bold text-[#35D0B0]">
          ...
          <span>SAFAR Driver Partner Network</span>
        </div>
      </div>
      ...
      <div className="text-center relative z-10 space-y-6">
        <div className="relative inline-block">
          <div className="absolute -inset-4 rounded-3xl bg-[#FAE3C1]/30 blur-xl animate-pulse" />
          <img
            src="/logo.png"
            alt="SAFAR Driver"
            className="w-28 h-28 rounded-3xl shadow-[0_0_40px_rgba(250,227,193,0.4)] relative object-cover border-2 border-[#FAE3C1]"
          />
        </div>

        <div>
          <h1 className="text-4xl font-black text-white tracking-wider">SAFAR DRIVER</h1>
      ...
      <div className="w-full max-w-xs space-y-3 pb-8 relative z-10">
        ...
        <div className="flex justify-between items-center text-[10px] font-bold text-[#A8AFBA]">
          <span>Initializing Driver Dispatch & Radar...</span>
