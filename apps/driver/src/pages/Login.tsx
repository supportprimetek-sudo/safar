...
import { SteeringWheel, Lock, Mail, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-safar-bg flex flex-col justify-center px-6 py-12">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <h2 className="text-3xl font-black tracking-tight text-white">SAFAR DRIVER</h2>
        <p className="text-sm text-safar-textMuted">Partner Portal • Drive & Earn Smart</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-safar-card p-8 rounded-3xl border border-white/10 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-safar-textMuted uppercase mb-1.5">Driver Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="driver.auto@safar.app"
            ...
            >
              <span>{loading ? 'Signing in...' : 'Sign In as Driver'}</span>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-safar-textMuted">
              Want to become a SAFAR Partner?{' '}
