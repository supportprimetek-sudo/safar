...
export const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      // Simulate slight driver movement around default Delhi coords
  ...
  const handleAcceptRide = async (rideId: string) => {
    try {
      const res = await apiFetch(`/api/rides/${rideId}/accept`, { method: 'POST' });
  ...
  return (
    <div className="min-h-screen bg-safar-bg p-4 max-w-lg mx-auto space-y-5 pb-12">
      {/* Header */}
